...
namespace GatewayService.AccountCharge.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251013114156_AddPrepaidInvoices")]
    partial class AddPrepaidInvoices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GatewayService.AccountCharge.Domain.PrepaidInvoices.PrepaidInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("ConfirmationsObserved")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ObservedAddress")
                        .HasMaxLength(256)
                    ...
                    b.Property<string>("ObservedTag")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");

                    b.Property<int?>("ObservedWalletId")
                        .HasColumnType("int");

                    b.Property<int>("RequiredConfirmationsObserved")
                        .HasColumnType("int");
                    ...
                    b.ToTable("PrepaidInvoices", (string)null);
                });
                    ...
                    b.OwnsMany("GatewayService.AccountCharge.Domain.Invoices.AppliedDeposit", "AppliedDeposits", b1 =>
                        {
                            ...
                            b1.OwnsOne("ChainAddress", "Address", b2 =>
                                {
